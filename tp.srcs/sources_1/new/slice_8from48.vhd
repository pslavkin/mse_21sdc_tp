...
architecture Behavioral of slice_8from48 is
            ...
            case state is
               when waitingSvalid =>
                  if s_axis_tvalid = '1' then                           --espero e que este listo para enviar algo
                     s_axis_tready <= '0';
                     bitCounter    := 0;
                     m_axis_tdata  <= s_axis_tdata(37 downto 30);
               ...
               when waitingMready =>
                  if m_axis_tready = '1' then                           --lo puedo empezar a mandar al otro lado?
                     bitCounter := bitCounter+8;                     --incremento
                     if bitCounter < 16 then                             --perfecto, porque bit voy?   
                        m_axis_tdata  <= s_axis_tdata(15 downto 8);
                     else
...
m_axis_config_tdata  <= "00000000"; --direct FFT
